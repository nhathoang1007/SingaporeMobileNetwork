package com.example.koin.base.adapter
...
abstract class BaseBindingAdapter<V : ViewDataBinding, T>(val onClicked: ((T?) -> Unit)? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): com.example.koin.base.adapter.BaseViewHolder<V> {
    ...
    override fun onBindViewHolder(holder: com.example.koin.base.adapter.BaseViewHolder<V>, position: Int) {
